 ...
 * @version 2.1.2
 */!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}((function(e){"use strict";var t=e.scrollTo=function(t,s,i){return e(window).scrollTo(t,s,i)};function s(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function i(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}return t.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(a,n,r){"object"==typeof n&&(r=n,n=0),"function"==typeof r&&(r={onAfter:r}),"max"===a&&(a=9e9),r=e.extend({},t.defaults,r),n=n||r.duration;var o=r.queue&&r.axis.length>1;return o&&(n/=2),r.offset=i(r.offset),r.over=i(r.over),this.each((function(){if(null!==a){var l,d=s(this),c=d?this.contentWindow||window:this,p=e(c),u=a,h={};switch(typeof u){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(u)){u=i(u);break}u=d?e(u):e(u,c);case"object":if(0===u.length)return;(u.is||u.style)&&(l=(u=e(u)).offset())}var m=e.isFunction(r.offset)&&r.offset(c,u)||r.offset;e.each(r.axis.split(""),(function(e,s){var i="x"===s?"Left":"Top",a=i.toLowerCase(),n="scroll"+i,v=p[n](),g=t.max(c,s);if(l)h[n]=l[a]+(d?0:v-p.offset()[a]),r.margin&&(h[n]-=parseInt(u.css("margin"+i),10)||0,h[n]-=parseInt(u.css("border"+i+"Width"),10)||0),h[n]+=m[a]||0,r.over[a]&&(h[n]+=u["x"===s?"width":"height"]()*r.over[a]);else{var b=u[a];h[n]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*g:b}r.limit&&/^\d+$/.test(h[n])&&(h[n]=h[n]<=0?0:Math.min(h[n],g)),!e&&r.axis.length>1&&(v===h[n]?h={}:o&&(f(r.onAfterFirst),h={}))})),f(r.onAfter)}function f(t){var s=e.extend({},r,{queue:!0,duration:n,complete:t&&function(){t.call(c,u,r)}});p.animate(h,s)}}))},t.max=function(t,i){var a="x"===i?"Width":"Height",n="scroll"+a;if(!s(t))return t[n]-e(t)[a.toLowerCase()]();var r="client"+a,o=t.ownerDocument||t.document,l=o.documentElement,d=o.body;return Math.max(l[n],d[n])-Math.min(l[r],d[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var s=this.get(t);if(t.options.interrupt&&t._last&&t._last!==s)return e(t.elem).stop();var i=Math.round(t.now);s!==i&&(e(t.elem)[t.prop](i),t._last=this.get(t))}},t})),function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}((function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function s(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var i=e.scrollTo=function(t,s,i){return e(window).scrollTo(t,s,i)};return i.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(a,n,r){"object"==typeof n&&(r=n,n=0),"function"==typeof r&&(r={onAfter:r}),"max"===a&&(a=9e9),r=e.extend({},i.defaults,r),n=n||r.duration;var o=r.queue&&1<r.axis.length;return o&&(n/=2),r.offset=s(r.offset),r.over=s(r.over),this.each((function(){function l(t){var s=e.extend({},r,{queue:!0,duration:n,complete:t&&function(){t.call(p,h,r)}});u.animate(m,s)}if(null!==a){var d,c=t(this),p=c?this.contentWindow||window:this,u=e(p),h=a,m={};switch(typeof h){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(h)){h=s(h);break}h=c?e(h):e(h,p);case"object":if(0===h.length)return;(h.is||h.style)&&(d=(h=e(h)).offset())}var f=e.isFunction(r.offset)&&r.offset(p,h)||r.offset;e.each(r.axis.split(""),(function(e,t){var s="x"===t?"Left":"Top",a=s.toLowerCase(),n="scroll"+s,v=u[n](),g=i.max(p,t);d?(m[n]=d[a]+(c?0:v-u.offset()[a]),r.margin&&(m[n]-=parseInt(h.css("margin"+s),10)||0,m[n]-=parseInt(h.css("border"+s+"Width"),10)||0),m[n]+=f[a]||0,r.over[a]&&(m[n]+=h["x"===t?"width":"height"]()*r.over[a])):(s=h[a],m[n]=s.slice&&"%"===s.slice(-1)?parseFloat(s)/100*g:s),r.limit&&/^\d+$/.test(m[n])&&(m[n]=0>=m[n]?0:Math.min(m[n],g)),!e&&1<r.axis.length&&(v===m[n]?m={}:o&&(l(r.onAfterFirst),m={}))})),l(r.onAfter)}}))},i.max=function(s,i){var a="scroll"+(n="x"===i?"Width":"Height");if(!t(s))return s[a]-e(s)[n.toLowerCase()]();var n="client"+n,r=(o=s.ownerDocument||s.document).documentElement,o=o.body;return Math.max(r[a],o[a])-Math.min(r[n],o[n])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var s=this.get(t);if(t.options.interrupt&&t._last&&t._last!==s)return e(t.elem).stop();var i=Math.round(t.now);s!==i&&(e(t.elem)[t.prop](i),t._last=this.get(t))}},i}));